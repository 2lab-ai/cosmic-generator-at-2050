import type { SourceEntry } from '@/types/data';

const PERMALINK_BASE = 'https://github.com/labforadvancedstudy/paper/blob/main/HAL/';

export const sources: SourceEntry[] = [
  {
    key: 'L1',
    title: 'Hierarchical Abstraction is All You Need: Continual AI Consciousness through Sleep-Wake Cycles',
  ...
  {
    key: 'L3A',
    title: 'A Backpropagation Approach to Multi-Level AI Orchestration: Agent-Neural Isomorphism',
    authors: 'Jihyuk Im, Claude Opus 4',
  ...
  {
    key: 'L3B',
    title: 'Cognitive Load Distribution Through Hierarchical Abstraction: 7±2 Rule',
    authors: 'Jihyuk Im, Claude Opus 4',
  ...
  {
    key: 'L4',
    title: 'Road to HAL9: Energy-Intelligence Scaling Laws with Uncertainty Quantification',
    authors: 'Jihyuk Im, Claude Opus 4',
  ...
  {
    key: 'L5',
    title: 'Hierarchical Abstraction is Emergence: A Field-Theoretic Framework',
    authors: 'Jihyuk Im, Claude Opus 4',
  ...
  {
    key: 'ROADMAP',
    title: 'HAL Implementation Roadmap 2025-2028',
    authors: 'Jihyuk Im, Claude Opus 4',
